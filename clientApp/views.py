...
def guarontor_list_view(request):
    ...
    return render(
        request,
        "pages/guarantors.html",
        {"guarantors": guarantors, "active": "guarantors"},
    )
...
def search_guarontor(request):
    if request.method == "POST":
        ...
        return render(
            request,
            "pages/guarantors.html",
            {"active": "guarantors", "guarantors": guarantors},
        )
    else:
        return render(
            request,
...
def clients_view(request):
    ...
    return render(
        request, "pages/clients.html", {"clients": clients, "active": "clients"}
    )
...
def search_client(request):
    if request.method == "POST":
        ...
        return render(
            request, "pages/clients.html", {"active": "clients", "clients": clients}
        )
    else:
        return render(
            request, "pages/clients.html", {"active": "clients", "clients": clients}
...
def viewclient(request, client_id):
    ...
    return render(
        request,
        "pages/clientview.html",
        {
            "client": client,
            "active_loans": client_active_loans,
            "total_loans": client_all_loans,
            "active_balance": client_active_balance,
            "all_loans": all_loans,
            "all_guaranted_loans": all_guaranted_loans,
        },
    )
